"""
Django settings for _baseserver project.
...
SECRET_KEY = 'django-insecure-o2a_y+usd32mn5+ktj=*^b6^bq*pv!v6rg##74f1y$av$(6hvj'
...
WSGI_APPLICATION = '_baseserver.wsgi.application'
